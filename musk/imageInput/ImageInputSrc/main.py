...
from TextInputSrc.ImageToHTML import ImageToHTML
sys.path.append("/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/models/research/")
...
sys.path.append('/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/')
...
PATH_TO_FROZEN_GRAPH = '/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/frozen_inference_graph_816.pb'

#give the path to label.pbtxt file
#it can be found in model_files directory

PATH_TO_LABELS = '/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/model_files/labels.pbtxt'
...
def write_temp(line):
  ...
  path='/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/temp/'
...
def generate_temp(coordinates, htmlPath):
  line=[]
  ...
  write_temp(line)
  #generate html code
  print('Starting Kishi code')
  # generate_html()
  # k = ImageToHTML("/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/temp/temp.txt", "/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/html/ou.html",950)
  k = ImageToHTML("/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/temp/temp.txt", htmlPath,950)
  k.createHTML()
  print("Ending Kishi's code")



def processImage(image, htmlPath, detectedImagePath): 
    ...
    if(coordinates):
      generate_temp(coordinates, htmlPath)
    
    dim=(950, 1000)
    resized = cv2.resize(image_np, dim, interpolation = cv2.INTER_AREA)
    # cv2.imwrite('./html/output_image.png', resized)
    cv2.imwrite(detectedImagePath, resized)
    ...
    # file_path = '/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/html/generated_code.html'
    # new = 2
    # webbrowser.open(file_path,new=new)


#For running on local testImage
#path of the image using which the html code is to be generated

# path='/home/swapnil/ai-musks/aawb/musk/imageInput/ImageInputSrc/test/test_imgs_8.jpg'
